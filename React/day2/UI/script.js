...
// // component :: function that return React Element (jsx)
// const App = () => {
//     return (
//         <div>
//             <header>
...
//                 </div>
//             </main>
//             <footer>&copy; Likhilesh.com</footer>
//         </div>
//     );
// };

// // const Title = <h1>Hello</h1>; // React element
...
//                 {ProductCard({ productName: "Washing Machine" })}
//                 {ProductCard({ productName: "T.V." })}
//             </main>
//             <footer>&copy; Likhilesh.com</footer>
//         </div>
//     );
...
//             </header>
//             <main>
//                 {ProductCard({ productName: "Mixer", price: 4000 })}
//                 {ProductCard({ productName: "Washing Machine", price: 15000 })}
//                 <ProductCard productName="Fan" price={2230} />
//                 {ProductCard({ productName: "T.V.", price: 30000 })}
//             </main>
//             <footer>&copy; Likhilesh.com</footer>
//         </div>
//     );
...
//                     imgLink={products[0].thumbnail}
//                 />
//                 <ProductCard
//                     productName={products[1].title}
//                     price={products[1].price}
//                     imgLink={products[1].thumbnail}
//                 />
//                 <ProductCard
//                     productName={products[2].title}
//                     price={products[2].price}
//                     imgLink={products[2].thumbnail}
//                 />
//                 <ProductCard
//                     productName={products[3].title}
//                     price={products[3].price}
//                     imgLink={products[3].thumbnail}
//                 />
//             </main>
//             <footer>&copy; Likhilesh.com</footer>
//         </div>
...
//     reading,writing,playing,working
// `;
...
const App = () => {
    return (
        <div>
            ...
            <main>
                {products.map((elem) => {
                    return <ProductCard productName={elem.title} price={elem.price} imgLink={elem.thumbnail} />;
                })}
            </main>
            <footer>&copy; Likhilesh.com</footer>
        </div>
