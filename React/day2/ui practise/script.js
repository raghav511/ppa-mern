...
// const title = React.createElement("h2",{},"HEllo this is heading")
// const paragraph = React.createElement("p",{},"HEllo this is paragraph")
// const div = React.createElement("div",{},[title,paragraph])
// reactRoot.render(div);
...
//     <h2>React Element</h2>
//     <p>
//       I am writing a react component which is nothing but a function and
//       internally with the help of Babel, React.createElement is created on top
//       of this.
//     </p>
//   </div>
// );
...
// const Container = (
//   <div>
//     {Card({ title: "Notice", paragraph: "THis is a Card Component usage" })}
//     {Card({ title: "Invitatoin", paragraph: "Welcome to party" })}
//     {Card1}
//   </div>
// );
...
const RecipeCard = (obj) => {
  return (
    <div className="card">
      <h3>Dish: {obj.Dishname}</h3>
      <img src={obj.DishImage} width="200"></img>
...
//       </header>
//       <main>
//         {RecipeCard({ Dishname: "Rice", Rating: 4 })}
//         {RecipeCard({ Dishname: "Idli", Rating: 5 })}
//         {RecipeCard({ Dishname: "Dosa", Rating: 3.9 })}
//         <RecipeCard Dishname="Chapati" Rating={5} />
//       </main>
//       <footer>&copy; Raghavendra.com</footer>
//     </div>
//   );
// };
...
//       <main>
//         <RecipeCard
//           Dishname={recipes[0].name}
//           Rating={recipes[0].rating}
//           DishImage={recipes[0].image}
//         />
//         <RecipeCard
//           Dishname={recipes[1].name}
//           Rating={recipes[1].rating}
//           DishImage={recipes[1].image}
//         />
//         <RecipeCard
//           Dishname={recipes[2].name}
//           Rating={recipes[2].rating}
//           DishImage={recipes[2].image}
//         />
//         <RecipeCard
//           Dishname={recipes[3].name}
//           Rating={recipes[3].rating}
//           DishImage={recipes[3].image}
//         />
//       </main>
//       <footer>&copy; Raghavendra.com</footer>
//     </div>
