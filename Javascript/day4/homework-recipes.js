...
for(recipe of recipes["recipes"]){
    ...
    recipeImage.className="images"
    recipeImage.src=recipe.image;
    recipeImage.alt=recipe.name;
    recipeImage.style.height="100px";
    ...
    recipeElement.append(recipeImage);
    recipeElement.append(recipeName);
    rootElement.append(recipeElement)
}